...
TRANSLATIONS = {
    ...
    "order_success_approved": {"en": "✅ Order approved — your purchase is confirmed!", "th": "✅ คำสั่งซื้อได้รับการอนุมัติ — ยืนยันการซื้อของคุณแล้ว!"},
    "order_success_rejected": {"en": "🚫 Order rejected — this transaction could not be completed.", "th": "🚫 คำสั่งซื้อถูกปฏิเสธ — ไม่สามารถทำรายการนี้ได้"},
    "order_success_on_hold": {"en": "⏳ Order placed on hold — our fraud team is reviewing it.", "th": "⏳ คำสั่งซื้อถูกระงับชั่วคราว — ทีมตรวจสอบการทุจริตกำลังพิจารณา"},
    "order_success_review": {"en": "🕵️ Order submitted for manual review — we'll notify you once processed.", "th": "🕵️ คำสั่งซื้อส่งเพื่อตรวจสอบด้วยตนเอง — เราจะแจ้งให้ทราบเมื่อดำเนินการเสร็จ"},
    ...
    "backlog_panel_title": {"en": "⏱️ Backlog Orders ({n}) — Delay Window Expired", "th": "⏱️ คำสั่งซื้อค้าง ({n}) — หมดเวลารอดำเนินการ"},
    "backlog_caption_pending": {"en": "These orders have exceeded their review/hold window and are waiting on a decision.", "th": "คำสั่งซื้อเหล่านี้เกินเวลารอดำเนินการแล้วและรอการตัดสินใจ"},
    "backlog_caption_clear": {"en": "✅ All caught up — no orders past their delay window.", "th": "✅ ดำเนินการครบแล้ว — ไม่มีคำสั่งซื้อที่เกินเวลา"},
    "find_backlog_orders": {"en": "🔍 Find Backlog Orders", "th": "🔍 ค้นหาคำสั่งซื้อค้าง"},
    "approve_all_backlog": {"en": "✅ Approve All Backlog", "th": "✅ อนุมัติค้างทั้งหมด"},
    "reject_all_backlog": {"en": "🚫 Reject All Backlog", "th": "🚫 ปฏิเสธค้างทั้งหมด"},
    "reject_all_backlog_fraud": {"en": "⚠️ Reject & Mark All as Fraud", "th": "⚠️ ปฏิเสธและทำเครื่องหมายเป็นการฉ้อโกงทั้งหมด"},
    "no_backlog_orders": {"en": "No backlog orders at the moment.", "th": "ไม่มีคำสั่งซื้อค้างในขณะนี้"},
    ...
    "auto_approved_toast": {"en": "Auto-approved {n} expired hold order(s).", "th": "อนุมัติอัตโนมัติคำสั่งซื้อที่หมดเวลารอ {n} รายการ"},
    ...
    "analyst_page_permissions": {"en": "### 🔐 Analyst Page Permissions", "th": "### 🔐 สิทธิ์การเข้าถึงหน้าของนักวิเคราะห์"},
    ...
    "delay_minutes_label": {"en": "Hold Delay (minutes)", "th": "ระยะเวลาระงับ (นาที)"},
    "delay_na": {"en": "Delay N/A", "th": "ไม่มีการระงับ"},
    "review_changes": {"en": "Review Changes", "th": "ตรวจสอบการเปลี่ยนแปลง"},

    # --- Charts (admin analytics) ---
    "chart_status_distribution": {"en": "Order Status Distribution", "th": "การกระจายสถานะคำสั่งซื้อ"},
    "chart_daily_volume": {"en": "Daily Order Volume — Current Month", "th": "ปริมาณคำสั่งซื้อรายวัน — เดือนปัจจุบัน"},
    "chart_rule_triggers": {"en": "Rule Trigger Counts", "th": "จำนวนครั้งที่กฎทำงาน"},
    "chart_date": {"en": "Date", "th": "วันที่"},
    "chart_orders": {"en": "Orders", "th": "คำสั่งซื้อ"},
    ...
    "power_bi_caption": {"en": "Embedded Power BI dashboards for fraud trends and KPIs.", "th": "แดชบอร์ด Power BI สำหรับแนวโน้มการทุจริตและ KPI"},
    "power_bi_missing_url": {"en": "POWER_BI_EMBED_URL is not configured. Add it to your .env file.", "th": "ยังไม่ได้ตั้งค่า POWER_BI_EMBED_URL กรุณาเพิ่มในไฟล์ .env"},
